...
- Exit code `0`.
- Output is `netcoredbg-mcp 0.20.4`.
...
3. Run the plan through the active v0.20.4 MCP server with the
...
This gate is the post-release consumer-readiness slice for the current v0.20.4
