...
| `#269` | `tests/test_runtime_smoke_registration.py::test_runtime_smoke_agent_lifecycle_tools_are_registered`; `tests/test_runtime_smoke_run_plan_facade.py`; `tests/test_runtime_smoke_run_probe_facade.py` | Lifecycle RED same as `#267`; CR-013 RED same as `#268`; CR-014 RED same as `#268` | `runtime_smoke_get_result` and `runtime_smoke_stop` were not registered; later evidence-bundle and run-probe behavior did not exist. |
