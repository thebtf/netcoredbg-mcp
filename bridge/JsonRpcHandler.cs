...
public static class JsonRpcHandler
{
    ...
    private static readonly IReadOnlyDictionary<string, Func<JsonNode?, UIA3Automation, AutomationElement?, JsonNode>> Handlers =
        new Dictionary<string, Func<JsonNode?, UIA3Automation, AutomationElement?, JsonNode>>
        {
            ...
            ["scoped_key_sequence"] = KeySequenceCommands.ScopedKeySequence,
            ...
            ["grid_double_click_row"] = GridCommands.DoubleClickRow,
            ["grid_drag_row_to_row"] = GridCommands.DragRowToRow,
            ...
            ["list_invoke_item"] = ListCommands.InvokeItem,
            ["list_toggle_item_child"] = ListCommands.ToggleItemChild,
    ...
    internal static JsonObject HandleNativeSceneEvidence(JsonObject request, int boundProcessId) =>
        NativeSceneEvidenceCommands.Handle(request, boundProcessId);
