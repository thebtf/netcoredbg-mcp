...
- schemas are checked-in **design candidates** until T001 approval. M0-G0 T002–T007 validates only exact-byte loading, contract/runtime-validator parity, corpus syntax/reference integrity, expected classification vocabulary, and negative structural/version cases. Full behavior, including C005–C016/C020 runtime behavior, is deferred to T032/T034 after implementation.
