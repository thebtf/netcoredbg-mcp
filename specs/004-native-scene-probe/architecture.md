...
| Scene artifact | 16,777,216 UTF-8 serialized bytes | Host checks the exact committed serialized size before descriptor return. |
| Visual artifact | 67,108,864 bytes | Host checks committed lossless file length independently from scene artifact size. |
