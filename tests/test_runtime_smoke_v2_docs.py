...
def test_sonarqube_release_policy_requires_two_clean_exact_head_receipts() -> None:
    ...
    for marker in (
        ...
        "recorded `project=thebtf_netcoredbg_mcp` analysis query",
        "submitted Compute Engine task's `componentKey`",
        ...
        "project-scoped hotspot inventory",
        "every other current issue is `BLOCKING_DISPOSITION`",
        "every hotspot is `BLOCKING_HOTSPOT`",
