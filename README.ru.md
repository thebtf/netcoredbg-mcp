...
**135 MCP-инструментов · 8 промптов · 4 ресурса · 2106 собранных тестов · релиз v0.23.5**
...
## Что нового в v0.23.5

- **Проверенная доставка scoped-клавиш в WPF** — `ui_key_sequence` возвращает
  `PASS` только когда native FlaUI bridge подтвердил foreground-владение и
  фокус именно на запрошенной цели до отправки последовательности. При
  отсутствии доказательства фокуса операция завершается fail-closed.
