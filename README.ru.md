...
**42 инструмента. 4 ресурса. 7 промптов. Один MCP-сервер.**
...
|-------------|----------|
| **42 MCP-инструмента** | Управление отладкой, точки останова, инспекция, вывод, UI-автоматизация, управление процессами |
...
### Управление отладкой (10 инструментов)
...
| `get_variables` | Чтение значений переменных из ссылки на область видимости. |
...
### UI-автоматизация (14 инструментов)

| Инструмент | Описание |
|------------|----------|
| `ui_get_window_tree` | Визуальное дерево окна приложения (AutomationId, тип, имя, enabled). |
| `ui_find_element` | Поиск элемента по AutomationId, имени или типу элемента управления. |
...
| `ui_click` | Клик по элементу по AutomationId, имени или типу. |
...
1. **MCP-слой** — `server.py` регистрирует 42 инструмента, 4 ресурса и 7 промптов через FastMCP
